  ...
  const products = [
    {
      ...
      images: [
        { src: "../src/assets/img/products/Ex3.png", alt: "Image 1" },
        { src: "../src/assets/img/products/cozy2.jpg", alt: "Image 2" },
        { src: "../src/assets/img/products/cozy3.jpg", alt: "Image 3" },
        { src: "../src/assets/img/products/cozy1.jpg", alt: "Image 4" },
      ],
    },
  ...
  const Cozywear = [
    {
      ...
      Highlights:"Hand cut and sewn locally,Dyed with our proprietary colors,Pre-washed & pre-shrunk,Ultra-soft 100% cotton",
      images: [
        { src: "../src/assets/img/products/Cozy Knitwear2.png", alt: "Image 1" },
        { src: "../src/assets/img/products/Cozy Knitwear2.1.png", alt: "Image 2" },
        { src: "../src/assets/img/products/Cozy Knitwear2.3.png", alt: "Image 3" },
        { src: "../src/assets/img/products/Cozy Knitwear2.4.png", alt: "Image 4" },
      ],
    },
  ...
  const CozyKnitwear = [
    {
      ...
      Highlights:"Hand cut and sewn locally,Dyed with our proprietary colors,Pre-washed & pre-shrunk,Ultra-soft 100% cotton",
      images: [
        { src: "../src/assets/img/products/Cozy Knitwear3.png", alt: "Image 1" },
        { src: "../src/assets/img/products/Cozy Knitwear3.1.png", alt: "Image 2" },
        { src: "../src/assets/img/products/Cozy Knitwear3.2.png", alt: "Image 3" },
        { src: "../src/assets/img/products/Cozy Knitwear3.3.png", alt: "Image 4" },
      ],
    },
