    ...
    const LadiesShorts1 = [
      {
        ...
        title: "T-Shirts",
        images: [
          { src: "../src/assets/img/products/MensTShirts4.png", alt: "Image 1" },
          { src: "../src/assets/img/products/MensTShirts1.png", alt: "Image 2" },
          { src: "../src/assets/img/products/MensTShirts2.png", alt: "Image 3" },
          { src: "../src/assets/img/products/MensTShirts3.png", alt: "Image 4" },
        ],
      },
    ];
    const LadiesShorts2 = [
      {
        ...
        title: "Polo T-Shirts",
        images: [
          { src: "../src/assets/img/products/MensPoloTShirts1.png", alt: "Image 1" },
          { src: "../src/assets/img/products/MensPoloTShirts2.png", alt: "Image 2" },
          { src: "../src/assets/img/products/MensPoloTShirts3.png", alt: "Image 3" },
          { src: "../src/assets/img/products/MensPoloTShirts4.png", alt: "Image 4" },
        ],
      },
    ];
    const LadiesShorts3 = [
      {
        ...
        images: [
          { src: "../src/assets/img/products/OversizedT-shirt1.png", alt: "Image 1" },
          { src: "../src/assets/img/products/OversizedT-shirt2.png", alt: "Image 2" },
          { src: "../src/assets/img/products/OversizedT-shirt3.png", alt: "Image 3" },
          { src: "../src/assets/img/products/OversizedT-shirt4.png", alt: "Image 4" },
        ],
      },
    ];
