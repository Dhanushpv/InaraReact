      ...
      >
        ...
        <div className="carousel-inner w-full">
          ...
          <div className="carousel-item active w-full ">
            <img
              src="../src/assets/img/hero-carousel/inaraintro.gif"
              className="w-full "
              alt="Slide 1"
            />
          </div>
          ...
          <div className="carousel-item">
            <img
              src="../src/assets/img/hero-carousel/inaraintro1.jpg"
              className="w-full"
              alt="Slide 2"
            />
          </div>
          ...
          <div className="carousel-item">
            <img
              src="../src/assets/img/hero-carousel/inaraintro2.jpg"
              className="w-full"
              alt="Slide 3"
            />
          </div>
          ...
          <div className="carousel-item">
            <img
              src="../src/assets/img/hero-carousel/inaraintro3.jpg"
              className="w-full"
              alt="Slide 3"
            />
          </div>
          ...
          <div className="carousel-item">
            <img
              src="../src/assets/img/hero-carousel/inaraintro4.gif"
              className="w-full"
              alt="Slide 3"
            />
          </div>
                ...
                <div className="absolute transform sm:left-1/2 sm:top-0 sm:translate-x-8 lg:left-1/2 lg:top-1/2 lg:-translate-y-1/2 lg:translate-x-8">
                  <div className="flex items-center space-x-6 lg:space-x-8">
                    ...
                    <div className="grid shrink-0 grid-cols-1 gap-y-6 lg:gap-y-8">
                      ...
                      <div className="h-64 w-44 overflow-hidden rounded-lg">
                        <img
                          src="../src/assets/img/products/Ex4.png"
                          alt=""
                          className="size-full object-cover"
                        />
                      </div>
                      <div className="h-64 w-44 overflow-hidden rounded-lg">
                        <img
                          src=" ../src/assets/img/products/Ex5.jpeg"
                          alt=""
                          className="size-full object-cover"
                        />
                      </div>
                    ...
                    <div className="grid shrink-0 grid-cols-1 gap-y-6 lg:gap-y-8">
                      <div className="h-64 w-44 overflow-hidden rounded-lg">
                        <img
                          src="../src/assets/img/products/Ex6.png"
                          alt=""
                          className="size-full object-cover"
                        />
                      </div>
                      <div className="h-64 w-44 overflow-hidden rounded-lg">
                        <img
                          src="../src/assets/img/products/Ex7.png"
                          alt=""
                          className="size-full object-cover"
                        />
                      </div>
              ...
              <div className="icon">
                <i className="fa-solid ">
                  <img
                    ...
                    src="../src/assets/img/icons/Design and Development.png"
                    alt=""
                  />
                </i>
              </div>
              ...
              <div className="icon">
                <i className="fa-solid ">
                  <img
                    ...
                    src="../src/assets/img/icons/Sample Making.png"
                    alt=""
                  />
                </i>
              </div>
            ...
            <div className="service-item position-relative">
              <div className="icon">
                <i className="fa-solid ">
                  <img
                    className="icon_image"
                    src="../src/assets/img/icons/Production.png"
                    alt=""
                  />
                </i>
              </div>
          ...
          <div className="flex flex-wrap min-h-screen">
            ...
            <div className="relative w-full lg:w-1/2 flex flex-col justify-end items-start p-8">
              <img
                ...
                src="../src/assets/img/cotton2.jpg"
              />
