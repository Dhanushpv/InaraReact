        ...
        <div className="row position-relative">
          ...
          >
            <img
              ...
              src="../src/assets/img/Services/floor-hanger-with-stylish-knitted-clothes-tropical-beach.jpg"
            />
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-2">
          <div className="text-center" data-aos="fade-up" data-aos-delay={100}>
            <img
              ...
              height={50}
              src="../src/assets/img/icons/Premium Fabrics.png"
              width={80}
            />
            ...
            <div className="rounded-lg overflow-hidden shadow-lg hover:shadow-2xl transition-shadow duration-300">
              <img
                ...
                height={400}
                src="../src/assets/img/Premium Fabricsimg.jpg"
                width={600}
              />
            </div>
          </div>
          <div className="text-center " data-aos="fade-up" data-aos-delay={100}>
            <div className="rounded-lg overflow-hidden shadow-lg hover:shadow-2xl transition-shadow duration-300 mb-4">
              <img
                ...
                className="w-full  h-[28rem]"
                height={400}
                src="../src/assets/img/Customer Serviceimg.jpg"
                width={600}
              />
            </div>
            <img
              ...
              className="mx-auto mb-4"
              height={20}
              src="../src/assets/img/icons/Customer Service.png"
              width={80}
            />
            <h2 className="text-2xl font-semibold mb-2 text-blue-800">
              Customer Service
          ...
          <div className="text-center" data-aos="fade-up" data-aos-delay={100}>
            <img
              ...
              className="mx-auto mb-4"
              height={50}
              src="../src/assets/img/icons/Sustainability.png"
              width={80}
            />
            <h2 className="text-2xl font-semibold mb-2 text-blue-800">
              Sustainability
            ...
            <div className="rounded-lg overflow-hidden shadow-lg hover:shadow-2xl transition-shadow duration-300">
              <img
                ...
                className="w-full  h-[28rem]"
                height={400}
                src="../src/assets/img/Premium Fabricsimg1.jpg"
                width={600}
              />
            </div>
          </div>
