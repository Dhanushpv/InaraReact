  ...
  const products = [
    {
      ...
      images: [
        { src: "../src/assets/img/products/ladiesinnerelastic5.png", alt: "Image 1" },
        { src: "../src/assets/img/products/ladiesinnerelastic4.png", alt: "Image 2" },
        { src: "../src/assets/img/products/ladiesinnerelastic3.png", alt: "Image 3" },
        { src: "../src/assets/img/products/ladiesinnerelastic2.png", alt: "Image 4" },
      ],
    },
  ...
  const outer = [
    {
      ...
      Highlights:"Hand cut and sewn locally,Dyed with our proprietary colors,Pre-washed & pre-shrunk,Ultra-soft 100% cotton",
      images: [
        { src: "../src/assets/img/products/ladiesouter12.png", alt: "Image 1" },
        { src: "../src/assets/img/products/ladiesouter3.jpg", alt: "Image 2" },
        { src: "../src/assets/img/products/ladiesouter4.jpg", alt: "Image 3" },
        { src: "../src/assets/img/products/ladiesouter2.jpg", alt: "Image 4" },
      ],
    },
  ...
  const trends = [
    {
      ...
      title: "Trends",
      images: [
        { src: "../src/assets/img/products/trends.png", alt: "Image 1" },
        { src: "../src/assets/img/products/trends1.jpg", alt: "Image 2" },
        { src: "../src/assets/img/products/trends2.jpg", alt: "Image 3" },
        { src: "../src/assets/img/products/trends3.jpg", alt: "Image 4" },
      ],
    },
  ];
