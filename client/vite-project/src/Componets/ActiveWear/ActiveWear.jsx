  ...
  const ActiveWears = [
    {
      ...
      title: "ActiveWear",
      images: [
        { src: "../src/assets/img/products/Active Wear1.png", alt: "Image 1" },
        { src: "../src/assets/img/products/Active Wear1.3.png", alt: "Image 2" },
        { src: "../src/assets/img/products/Active Wear1.2.png", alt: "Image 3" },
        { src: "../src/assets/img/products/Active Wear1.5.png", alt: "Image 4" },
      ],
    },
  ];
  const ActiveWears1 = [
    {
      ...
      title: "Slips",
      images: [
        { src: "../src/assets/img/products/Nightwear2.png", alt: "Image 1" },
        { src: "../src/assets/img/products/Active Wear2.png", alt: "Image 2" },
        { src: "../src/assets/img/products/Nightwear3.png", alt: "Image 3" },
        { src: "../src/assets/img/products/Nightwear1.png", alt: "Image 4" },
      ],
    },
  ];
  const ActiveWears2 = [
