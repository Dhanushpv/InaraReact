    ...
    >
      <div className="bg-white overflow-hidden rounded-[15px]  sm:h-auto lg:h-full">
        <div className="relative isolate px-4 sm:px-6 lg:px-8">
          ...
          >
            <img
              src="../src/assets/img/wooden-table.jpg"
      ...
      <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8  lg:mx-0 lg:max-w-none lg:grid-cols-2 lg:items-start ">
        ...
        <div className="-ml-12 -mt-12 p-12 lg:sticky lg:top-4 lg:col-start-2 lg:row-span-2 lg:row-start-1 lg:overflow-hidden">
          <img
            ...
            src="../src/assets/img/Services/services (5).png"
            alt=""
          />
        </div>
    ...
    <div className="bg-white" data-aos="fade-up" data-aos-delay={100}>
      ...
      <div className="mx-auto grid max-w-2xl grid-cols-1 items-center gap-x-8 gap-y-16 px-4 py-4 sm:px-6 sm:py-14 lg:max-w-7xl lg:grid-cols-2 lg:px-8">
        <div className="image-grid grid grid-cols-2 grid-rows-2 gap-4 sm:gap-6 lg:gap-8 hidden lg:grid">
          <img
            src="./assets/img/Services/sample_services1.png"
            alt="Walnut card tray with white powder coated steel divider and 3 punchout holes."
            className="rounded-lg bg-gray-100"
          />
          <img
            src="./assets/img/Services/sample_services3.png"
            alt="Top down view of walnut card tray with embedded magnets and card groove."
            className="rounded-lg bg-gray-100"
          />
          <img
            src="./assets/img/Services/sample_services4.png"
            alt="Side of walnut card tray with card groove and recessed card area."
            className="rounded-lg bg-gray-100"
          />
          <img
            src="./assets/img/Services/sample_services5.png"
        ...
        <div className="image-grid grid grid-cols-2 grid-rows-2 gap-4 sm:gap-6 lg:gap-8 lg:grid">
          <img
            src="../src/assets/img/Services/sample_services1.png"
            alt="Walnut card tray with white powder coated steel divider and 3 punchout holes."
            className="rounded-lg bg-gray-100"
          />
          <img
            src="../src/assets/img/Services/sample_services3.png"
            alt="Top down view of walnut card tray with embedded magnets and card groove."
            className="rounded-lg bg-gray-100"
          />
          <img
            src="../src/assets/img/Services/sample_services4.png"
            alt="Side of walnut card tray with card groove and recessed card area."
            className="rounded-lg bg-gray-100"
          />
          <img
            src="../src/assets/img/Services/sample_services5.png"
            alt="Walnut card tray filled with cards and card angled in dedicated groove."
            className="rounded-lg bg-gray-100"
          />
        </div>
    ...
    <div className="bg-white" data-aos="fade-up" data-aos-delay={100}>
      <div className="mx-auto grid max-w-2xl grid-cols-1 items-center gap-x-8 gap-y-16 px-4 py-4 sm:px-6 sm:py-14 lg:max-w-7xl lg:grid-cols-2 lg:px-8">
        ...
        <div className="grid grid-cols-2 grid-rows-2 gap-4 sm:gap-6 lg:gap-8">
          <img
            src="../src/assets/img/Services/private_services1.png"
            alt="Walnut card tray with white powder coated steel divider and 3 punchout holes."
            className="rounded-lg bg-gray-100"
          />
          <img
            src="../src/assets/img/Services/private_services2.png"
            alt="Top down view of walnut card tray with embedded magnets and card groove."
            className="rounded-lg bg-gray-100"
          />
          <img
            src="../src/assets/img/Services/private_services3.png"
            alt="Side of walnut card tray with card groove and recessed card area."
            className="rounded-lg bg-gray-100"
          />
          <img
            src="../src/assets/img/Services/private_services4.png"
            alt="Walnut card tray filled with cards and card angled in dedicated groove."
            className="rounded-lg bg-gray-100"
          />
        </div>
    ...
    <div className="bg-white" data-aos="fade-up" data-aos-delay={100}>
      <div className="mx-auto grid max-w-2xl grid-cols-1 items-center gap-x-8 gap-y-16 px-4  sm:px-6 sm:py-14 lg:max-w-7xl lg:grid-cols-2 lg:px-8">
        ...
        <div className="image-grid grid grid-cols-2 grid-rows-2 gap-4 sm:gap-6 lg:gap-8 hidden lg:grid Customisedimg">
          <img
            src="./assets/img/Services/custom_services1.png"
            alt="Walnut card tray with white powder coated steel divider and 3 punchout holes."
            className="rounded-lg bg-gray-100"
          />
          <img
            src="./assets/img/Services/custom_services2.png"
            alt="Top down view of walnut card tray with embedded magnets and card groove."
            className="rounded-lg bg-gray-100"
          />
          <img
            src="./assets/img/Services/custom_services3.png"
            alt="Side of walnut card tray with card groove and recessed card area."
            className="rounded-lg bg-gray-100"
          />
          <img
            src="./assets/img/Services/custom_services4.png"
            alt="Walnut card tray filled with cards and card angled in dedicated groove."
            className="rounded-lg bg-gray-100"
          />
        </div>
        ...
        <div className="image-grid grid grid-cols-2 grid-rows-2 gap-4 sm:gap-6 lg:gap-8 lg:grid Customisedimgmain">
          <img
            src="../src/assets/img/Services/custom_services1.png"
            alt="Walnut card tray with white powder coated steel divider and 3 punchout holes."
            className="rounded-lg bg-gray-100"
          />
          <img
            src="../src/assets/img/Services/custom_services2.png"
            alt="Top down view of walnut card tray with embedded magnets and card groove."
            className="rounded-lg bg-gray-100"
          />
          <img
            src="../src/assets/img/Services/custom_services3.png"
            alt="Side of walnut card tray with card groove and recessed card area."
            className="rounded-lg bg-gray-100"
          />
          <img
            src="../src/assets/img/Services/custom_services4.png"
            alt="Walnut card tray filled with cards and card angled in dedicated groove."
            className="rounded-lg bg-gray-100"
          />
        </div>
