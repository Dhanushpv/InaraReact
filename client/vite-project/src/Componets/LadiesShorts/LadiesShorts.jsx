  ...
  const LadiesShorts1 = [
    {
      ...
      title: "ActiveWear",
      images: [
        { src: "../src/assets/img/products/ladiesShorts.png", alt: "Image 1" },
        { src: "../src/assets/img/products/ladiesShorts1.3.png", alt: "Image 2" },
        { src: "../src/assets/img/products/ladiesShorts1.1.png", alt: "Image 3" },
        { src: "../src/assets/img/products/ladiesShorts1.2.png", alt: "Image 4" },
      ],
    },
  ];
  const LadiesShorts2 = [
    {
      ...
      title: "Slips",
      images: [
        { src: "../src/assets/img/products/ButterFlyShorts3.png", alt: "Image 1" },
        { src: "../src/assets/img/products/ButterFlyShorts2.png", alt: "Image 2" },
        { src: "../src/assets/img/products/ButterFlyShorts1.png", alt: "Image 3" },
        { src: "../src/assets/img/products/ButterFlyShorts4.png", alt: "Image 4" },
      ],
    },
  ];
  const LadiesShorts3 = [
    {
      ...
      title: "Slips",
      images: [
        { src: "../src/assets/img/products/ladiesShorts4.png", alt: "Image 1" },
        { src: "../src/assets/img/products/BermudaShorts1.png", alt: "Image 2" },
        { src: "../src/assets/img/products/BermudaShorts2.png", alt: "Image 3" },
        { src: "../src/assets/img/products/BermudaShorts3.png", alt: "Image 4" },
      ],
    },
  ];
