      ...
      const Menshorts = [
        {
          ...
          title: "Shorts",
          images: [
            { src: "../src/assets/img/products/mensShorts2.png", alt: "Image 1" },
            { src: "../src/assets/img/products/mensShorts3.png", alt: "Image 2" },
            { src: "../src/assets/img/products/mensShorts4.png", alt: "Image 3" },
            { src: "../src/assets/img/products/mensShorts1.png", alt: "Image 4" },
          ],
        },
      ];
      const MenTracks = [
        {
          ...
          title: "Tracks",
          images: [
            { src: "../src/assets/img/products/Men'sTrackpants1.png", alt: "Image 1" },
            { src: "../src/assets/img/products/Men'sTrackpants3.png", alt: "Image 2" },
            { src: "../src/assets/img/products/Men'sTrackpants2.png", alt: "Image 3" },
            { src: "../src/assets/img/products/Men'sTrackpants4.png", alt: "Image 4" },
          ],
        },
      ];
return (
      ...
      <div className="max-w-6xl mx-auto p-4">
          ...
          >
            <a onClick={() => navigate("/LadiesUnderwear")}>
              <img
                ...
                src="../src/assets/img/products/catlog (11).png"
                width={600}
              />
          ...
          >
            <a onClick={() => navigate("/Cozyknitting")}>
              <img
                ...
                className="w-full h-full"
                 src="../src/assets/img/products/Ex3.png"
                width={600}
              />
              <div className="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center hover-text">
                <h2 className="text-white text-xl font-semibold">
          ...
          >
            <a onClick={() => navigate("/ActiveWear")}>
              <img
                alt="Handcrafted Collection - A leather keychain with keys on a wooden surface"
                className="w-full h-full"
                 src="../src/assets/img/products/Ex2.png"
                width={600}
              />
              <div className="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center hover-text">
                <h2 className="text-white text-xl font-semibold">
          ...
          >
            <a onClick={() => navigate("/LadiesShorts")}>
              <img
                alt="Handcrafted Collection - A leather keychain with keys on a wooden surface"
                className="w-full h-full"
                 src="../src/assets/img/products/Ex1.png"
                width={600}
              />
              <div className="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center hover-text">
        ...
        >
          <div
            ...
            className="relative bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300 hover-zoom"
          >
            <a onClick={() => navigate("/MensVest")}>
              <img
                alt="Handcrafted Collection - A leather keychain with keys on a wooden surface"
                className="w-full h-full "
                src="../src/assets/img/products/underwear(s).png"
                width={600}
              />
              <div className="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center hover-text">
                <h2 className="text-white text-xl font-semibold">
          ...
          >
              ...
              <img
                alt="Handcrafted Collection - A leather keychain with keys on a wooden surface"
                className="w-full h-full "
                src="../src/assets/img/products/catlog (6).png"
                width={600}
              />
              <div className="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center hover-text">
                <h2 className="text-white text-xl font-semibold">Shorts</h2>
          ...
          >
            <a onClick={() => navigate("/MensTShirts")}>
              <img
                alt="Handcrafted Collection - A leather keychain with keys on a wooden surface"
                className="w-full h-full "
                src="../src/assets/img/products/tShirt.png"
                width={600}
              />
              <div className="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center hover-text">
          ...
          >
              ...
              <img
                alt="Handcrafted Collection - A leather keychain with keys on a wooden surface"
                className="w-full h-full "
                src="../src/assets/img/products/catlog (4).png"
                width={600}
              />
              <div className="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center hover-text">
                <h2 className="text-white text-xl font-semibold">
